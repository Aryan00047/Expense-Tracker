    ...
    const header_items = [
        ...
        return (<>
                    ...
                    <div className="flex flex-col items-start max-w-xl justify-center gap-3 p-2">
                        ...
                        <div className="p-2 space-y-2">
                            <h2 className="text-2xl sm:text-3xl md:text-4xl leading-tight">
                                ...
                                Reach Every <span className="text-blue-600">Goal</span>
                                </span>
                            </h2>
                            <p className="mt-2 text-xs sm:text-sm md:text-lg text-gray-600 leading-relaxed">
                                Take control of your finances with intelligent expense tracking, real-time insights,
                                and automated budgeting tools designed for modern life.
                            </p>
                        </div>
           ...
           <div className="p-2 m-2 flex flex-col items-center text-center">
                <h2 className="text-2xl md:text-4xl mb-2">Everything You Need To Manage Money</h2>
                <span className="text-xs md:text-lg">Powerful features that make expense tracking effortless</span>
           </div>
           ...
           <div className="px-4 sm:px-6 lg:px-8 m-6">
                <div className="py-10 relative overflow-hidden mx-auto flex flex-col items-center justify-center text-center bg-linear-to-r from-purple-500 to-blue-500 w-full max-w-7xl rounded-2xl">
                        <h3 className="text-white inline-flex text-3xl md:text-5xl sm:text-4xl">Ready to Take Control?</h3>
                        <span className="text-white inline-flex text-xs sm:text-sm md:text-lg mt-2">Join ExpenseFlow today and start your journey to financial freedom!</span>
